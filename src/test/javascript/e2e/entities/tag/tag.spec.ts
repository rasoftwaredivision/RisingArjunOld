...
describe('Tag e2e test', () => {
  ...
  it('should load create Tag page', async () => {
    ...
    expect(await tagUpdatePage.getPageTitle().getAttribute('id')).to.match(/risingArjunApp.tag.home.createOrEditLabel/);
  ...
  it('should delete last Tag', async () => {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/risingArjunApp.tag.delete.question/);
