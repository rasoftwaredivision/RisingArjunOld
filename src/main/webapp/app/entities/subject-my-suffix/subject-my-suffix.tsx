...
import { getEntities } from './subject-my-suffix.reducer';
import { ISubjectMySuffix } from 'app/shared/model/subject-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ISubjectMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export class SubjectMySuffix extends React.Component<ISubjectMySuffixProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="subject-my-suffix-heading">
          <Translate contentKey="risingArjunApp.subject.home.title">Subjects</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="risingArjunApp.subject.home.createLabel">Create new Subject</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {subjectList && subjectList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="risingArjunApp.subject.home.notFound">No Subjects found</Translate>
            </div>
          )}
        </div>
      </div>
