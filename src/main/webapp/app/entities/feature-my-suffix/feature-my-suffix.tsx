...
import { getEntities } from './feature-my-suffix.reducer';
import { IFeatureMySuffix } from 'app/shared/model/feature-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IFeatureMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export class FeatureMySuffix extends React.Component<IFeatureMySuffixProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="feature-my-suffix-heading">
          <Translate contentKey="risingArjunApp.feature.home.title">Features</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="risingArjunApp.feature.home.createLabel">Create new Feature</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {featureList && featureList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="risingArjunApp.feature.home.notFound">No Features found</Translate>
            </div>
          )}
        </div>
      </div>
