...
import com.risingarjun.arjun.domain.Entry;
import com.risingarjun.arjun.repository.EntryRepository;
...
/**
 * REST controller for managing {@link com.risingarjun.arjun.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
